  ...
  module Formatter
    ...
    class Progress
      ...
      def initialize(config)
        ...
        @snippets_input = []
        @total_duration = 0
        @summary = Cucumber::Core::Report::Summary.new
        @matches = {}
      ...
      def on_before_test_case(_event)
      ...
      def on_after_test_step(event)
        ...
        unless HookQueryVisitor.new(test_step).hook?
          ...
          summary.after_test_step(test_step, result)
      ...
      def on_after_test_case(event)
        ...
        summary.after_test_case(test_case, result)
      end
